    ...
    >
      ...
      <View className='h-full flex-col justify-between'>
        ...
        <View
          ...
          >
            <View className='flex-row items-center'>
              ...
              <View>
                ...
                <Text
                        className="text-app-orange text-sm font-[Sora-Semibold] ml-3"
          ...
          <TouchableOpacity 
                className={`${totalPrice=== 0 ? 'bg-[#EDEDED]' : 'bg-app-orange' }  2-full rounded-2xl items-center justify-center mt-6 py-3`}

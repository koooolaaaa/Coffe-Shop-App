...
import SizeSection from '@/components/SizeSections';
      ...
      <View className='h-full flex-col justify-between'>
        ...
        > 
          <View>
            ...
            <Text
                    className="text-app-orange text-2xl font-[Sora-SemiBold]"
              >$ {price}
            </Text>
          </View>
            
          <TouchableOpacity 
                className="bg-app-orange w-[70%] rounded-3xl items-center justify-center" 
                onPress = {buyNow}
              >

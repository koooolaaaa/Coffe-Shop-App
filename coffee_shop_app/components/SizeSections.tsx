    ...
    <View>
        ...
        <View className="flex-row justify-center items-center space-x-4 mt-3 mb-3">
            ...
            <TouchableOpacity
                ...
                selectedSize === size ? 'bg-[#fdf5f0] border-2 border-app-orange' : 'bg-white'
                }`}
            >
                <Text className={`font-[Sora-Regular] ${selectedSize === size ? 'text-app-orange' : 'text-black'}`}>{size}</Text>
            </TouchableOpacity>
            ))}
        </View>
    </View>
